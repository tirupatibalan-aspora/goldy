...
if [ "$IS_FIRST_RUN" = true ]; then
  ...
  echo "  A shared brain for cross-platform development."
  echo "  It watches your repos, remembers everything, and keeps"
  echo "  AI sessions informed — so you never re-explain context."
  echo ""
